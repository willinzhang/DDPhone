...
import StaticContainer from './BaseStatiContainer'
import Tab from './BaseTab'
import TabBar from './BaseTabBar'
import TabNavigatorItem from './BaseTabNavigatorItem'
  ...
  _renderTab (item) {
    ...
    return (
      <Tab
        ...
        onLongPress={item.props.onLongPress}
